...
func (query InwQueryBuilder) WhereString(field, conditions string) InwQueryBuilder {
	query.searchOpts.WhereString = append(query.searchOpts.WhereString, whereStringOpt{
		Field:      field,
